...
namespace testform
{
    public partial class fSetCam3 : Form
    {
        ...
        private void btnSaveSetting_Click(object sender, EventArgs e)
        {
            ...
            cam3.resolucion = cbxResolution.SelectedValue.ToString();
            cam3.compression = lblCompression.Text;
            string url_cam1 = cam3.ip_server + "/axis-cgi/mjpg/video.cgi?resolution=" + cbxResolution.SelectedValue.ToString() +
                              "&compression=" + lblCompression.Text + "&camera=1";
            AMCfcam3.MediaURL = url_cam1;
            AMCfcam3.MediaType = "MJPG";

            //BRIGHTNESS 
            string urlBright = cam3.ip_server + "/axis-cgi/param.cgi?action=update&ImageSource.I0.Sensor.brightness=" + lblBright.Text;
            NetworkCredential networkCredential = new NetworkCredential(cam3.user, cam3.password);
            ...
            //CONTRAST
            string urlContrast = cam3.ip_server + "/axis-cgi/param.cgi?action=update&ImageSource.I0.Sensor.Contrast=" + lblContrast.Text;
            NetworkCredential networkCredential2 = new NetworkCredential(cam3.user, cam3.password);
            ...
            //SATURATION
            string urlSaturation = cam3.ip_server + "/axis-cgi/param.cgi?action=update&ImageSource.I0.Sensor.Colordesaturation=" + lblSaturation.Text;
            NetworkCredential networkCredential3 = new NetworkCredential(cam3.user, cam3.password);
            ...
            //SHARPNESS
            string urlSharpness = cam3.ip_server + "/axis-cgi/param.cgi?action=update&ImageSource.I0.Sensor.Sharpness=" + lblSharpness.Text;
            NetworkCredential networkCredential4 = new NetworkCredential(cam3.user, cam3.password);
            ...
            //WHITE BALANCE
            string urlWB = cam3.ip_server + "/axis-cgi/param.cgi?action=update&ImageSource.I0.Sensor.WhiteBalance=" + cbxWhiteBalance.SelectedValue.ToString();
            NetworkCredential networkCredential5 = new NetworkCredential(cam3.user, cam3.password);
            ...
            //EXPOSURE VALUE
            string urlEV = cam3.ip_server + "/axis-cgi/param.cgi?action=update&ImageSource.I0.Sensor.ExposureValue=" + lblExposureValue.Text;
            NetworkCredential networkCredential6 = new NetworkCredential(cam3.user, cam3.password);
            ...
            //Exposure 
            string urlEZ = cam3.ip_server + "/axis-cgi/param.cgi?action=update&ImageSource.I0.Sensor.ExposureWindow=" + cbxExposureZone.SelectedValue.ToString();
            NetworkCredential networkCredential7 = new NetworkCredential(cam3.user, cam3.password);
            ...
            //Exposure Control
            string urlEC = cam3.ip_server + "/axis-cgi/param.cgi?action=update&ImageSource.I0.Sensor.Exposure=" + cbxExposureControl.SelectedValue.ToString();
            NetworkCredential networkCredential8 = new NetworkCredential(cam3.user, cam3.password);
            ...
            // Gain max
            string urlShutterMAX = cam3.ip_server + "/axis-cgi/param.cgi?action=update&ImageSource.I0.Sensor.ManGainVal=" + cbxMaxGain.SelectedValue.ToString();
            NetworkCredential networkCredential9 = new NetworkCredential(cam3.user, cam3.password);
            ...
            string urlOver = $"{cam3.ip_server}/axis-cgi/param.cgi?action=update&Image.I0.Text.TextEnabled=yes&Image.I0.Text.String={txtOverlay.Text}" +
                             $"&Image.I0.Text.Position={cbxPlaceText.Text}&Image.I0.Text.Color={cbxColorText.Text}&Image.I0.Text.BGColor={cbxBkgColor.Text}";
            NetworkCredential networkCredentialOverlay = new NetworkCredential(cam3.user, cam3.password);
        ...
        private void fSetCam3_Load(object sender, EventArgs e)
        {
            cargar_componentes();
            reset_default_settings();
        }
        ...
        {
            lblContrast.Text = tkbSaturation.Value.ToString();
